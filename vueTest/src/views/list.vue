<script>
  export default {
    data() {
      ...
      return {
        lists: [
            {"id":1,"title":"1","img":"bg1","color":"rgba(173, 171, 163, 0.7)"},
            {"id":2,"title":"2","img":"bg2","color":"rgba(173, 171, 163, 0.7)"},
            {"id":3,"title":"3","img":"bg3","color":"rgba(173, 171, 163, 0.7)"},
            {"id":4,"title":"4","img":"bg4","color":"rgba(173, 171, 163, 0.7)"},
            {"id":4,"title":"4","img":"bg4","color":"rgba(173, 171, 163, 0.7)"},
            {"id":4,"title":"4","img":"bg4","color":"rgba(173, 171, 163, 0.7)"},
            {"id":4,"title":"4","img":"bg4","color":"rgba(173, 171, 163, 0.7)"},
            {"id":4,"title":"4","img":"bg4","color":"rgba(173, 171, 163, 0.7)"},
...
<template>
  <header class="header mui-bar mui-bar-nav">
    ...
    <!--<button @click="goAsi" v-link="{ path: '/asi' }" class="mui-btn mui-btn-link mui-btn-nav mui-pull-right"><span
  ...
  <div class="mui-content">
    <div class="eating-box">
      <ul>
        ...
        <li class="eating-card eating-null" v-if="!listState">
        ...
        <li class="eating-card" v-for="item in lists" :class="item.img" @click="openDelIt(item.id)">
          <div class="eating-card-title" style="background-color:rgba(173, 171, 163, 0.7);"><span>{{item.title}}</span>
          </div>
        </li>
      </ul>
    </div>
